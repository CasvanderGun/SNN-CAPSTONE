...
# Plot parameters
EXPORT_METRICS = True
EXPORT_DIR = Path('../../results/train_decay_eval_decay/output_metrics')
SAVE_DIR = Path('../../results/train_decay_eval_decay/best_model')
NEURON_DIR = Path('../../results/train_decay_eval_decay/neuron_plots')
SPIKETRAIN_DIR = Path('../../results/train_decay_eval_decay/spike_trains')
