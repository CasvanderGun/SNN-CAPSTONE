...
def train_count_eval_ttfs(epochs, export_path):
    ...
    for epoch in range(N_TRAINING_EPOCHS):
        ...
        create_spike_count_map(avg_spike_counts, 800, 15, f"Epoch{epoch+1}_train_count_eval_ttfs_800", export_path, '/neuron_plots/')
        create_spike_count_map(avg_spike_counts, 100, 15, f"Epoch{epoch+1}_train_count_eval_ttfs_100", export_path, '/neuron_plots/')
