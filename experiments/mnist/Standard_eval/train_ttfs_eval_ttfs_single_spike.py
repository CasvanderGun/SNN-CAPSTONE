...
if __name__ == "__main__":
    ...
    for epoch in range(N_TRAINING_EPOCHS):
        ...
        create_spike_count_map(avg_output_spike_counts, 10, 1, f'OUTPUTSpikeCountMap_10Neurons_TTFS_TTFS_SINGLE_Epoch{epoch + 1}', 'train_ttfs_eval_ttfs_single_spike', '/content/SNN-CAPSTONE/')

        create_spike_count_map(avg_spike_counts, 800, 1, f'SpikeCountMap_800Neurons_TTFS_TTFS_SINGLE_Epoch{epoch + 1}', 'train_ttfs_eval_ttfs_single_spike', '/content/SNN-CAPSTONE/')
        create_spike_count_map(avg_spike_counts, 100, 1, f'SpikeCountMap_100Neurons_TTFS_TTFS_SINGLE_Epoch{epoch + 1}', 'train_ttfs_eval_ttfs_single_spike', '/content/SNN-CAPSTONE/')
