...
if __name__ == "__main__":
    ...
    for epoch in range(N_TRAINING_EPOCHS):
      ...
      create_spike_count_map(avg_spike_counts, 800, 15, f'SpikeCountMap_800Neurons_Count_Count_Epoch{epoch + 1}', 'train_count_eval_count')
      create_spike_count_map(avg_spike_counts, 100, 15, f'SpikeCountMap_100Neurons_Count_Count_Epoch{epoch + 1}', 'train_count_eval_count')
