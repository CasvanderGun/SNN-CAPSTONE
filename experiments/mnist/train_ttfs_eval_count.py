...
# Plot parameters
EXPORT_METRICS = True
EXPORT_DIR = Path("/content/SNN-CAPSTONE/results/train-ttfs-eval-count/output_metrics")
SAVE_DIR = Path("/content/SNN-CAPSTONE/results/train-ttfs-eval-count/best_model")
