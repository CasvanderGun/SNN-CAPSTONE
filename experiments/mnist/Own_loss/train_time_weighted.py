...
# Plot parameters
EXPORT_METRICS = True
EXPORT_DIR = Path("/content/SNN-CAPSTONE/results/train_time_weighted_eval_time_weighted/output_metrics")
SAVE_DIR = Path("/content/SNN-CAPSTONE/results/train_time_weighted_eval_time_weighted/best_model")
...
if __name__ == "__main__":
    ...
    loss_fct = SpikeTimeWeightedSoftmaxCrossEntropy(decay_rate=DECAY_RATE)
    ...
    for epoch in range(N_TRAINING_EPOCHS):
        ...
        #create_spike_count_map(avg_spike_counts, 800, 5, f'SpikeCountMap_800Neurons_TTFS_TTFS_Epoch{epoch + 1}', '/content/SNN-CAPSTONE/')
        #create_spike_count_map(avg_spike_counts, 100, 5, f'SpikeCountMap_100Neurons_TTFS_TTFS_Epoch{epoch + 1}', '/content/SNN-CAPSTONE/')
